...
def check_shear_bearing( hole_diameter, lug_thickness, edge_to_center_hole_distance,
    ...
    try:
        K_bru = Shear_Bearing_Graphs.shear_bearing_graph(13, hole_diameter/lug_thickness, 1)
        A_br = hole_diameter * lug_thickness

        P_bru = K_bru * material_ultimate_tensile_strength * A_br

        # 2 - shear-bearing yield failure
        K_bry = Shear_Bearing_Graphs.shear_bearing_graph(14, hole_diameter/lug_thickness, 1)
        ...
        pass  # print(f"Lug test failed due to graph being out of bounds; check_shear_bearing")
...
def check_bolt_pin_bending(hole_diameter, lug_thickness, lug_height, edge_to_center_hole_distance,
    ...
    try:
        ...
        pass  # print(f"Lug test failed due to graph being out of bounds; check_bolt_pin_bending")