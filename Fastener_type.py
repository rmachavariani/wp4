...
def Fastener_Type(thickness_backplate, thickness_vehiclewall, inner_diameter_fastener, outer_diameter_fastener, youngs_modulus_backplate, youngs_modulus_fastener, youngs_modulus_vehiclewall):
